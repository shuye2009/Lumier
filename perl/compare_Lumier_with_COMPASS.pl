...
my %scores = ("prohits" => {"untreated" => 16, "Rnase" => 15.5}, "maxquant" => {"untreated" => 5, "Rnase" => 5}); #determined in format_prohits_for_COMPASS.R
foreach my $subdir ("maxquant", "prohits"){
foreach my $dataset ("untreated", "Rnase"){
my $score_cutoff = $scores{$subdir}{$dataset};
my $saint = "C:/RSYNC/LUMIER_C2H2/Archive_oct032018/Archive1_3/Results_oct032018_control_distribution_normalization/HGscore_from_APMS_180913/".$subdir."/".$dataset."_COMPASS_score.tab";
...
#		my $wd = "C:/RSYNC/LUMIER_C2H2/SecondProtocol/".$dir."/".$method;
		...
		#foreach my $treat("NT", "RN", "SNDREAD"){
			...
			my $saint_basedon_lumier = $outdir."/".$treat."_".$method."_".$dataset."_COMPASS_network_cutoff_".$score_cutoff.".tab";
			...
			print "done\t$method\t$treat\tLUMIER size: $lumier_size\tLUMIER in COMPASS: $lumierINsaint\tCOMPASS in LUMIER: $saintINlumier\n";
		#}
	#}
#}
