...
#working directory C:\RSYNC\LUMIER_C2H2\Nov_10_2016_EM

use Statistics::Descriptive qw(:all);
use Regexp::Common;

my $int_file = "inter_Nov_10_2016_EM.dat";
my $prey_file = "prey_Nov_10_2016_EM.dat";
...
open(IN, "<$int_file") or die "file cannot be found\n";
open(P, "<$prey_file") or die "file cannot be found\n";
